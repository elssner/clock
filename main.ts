...
function hour_marks () {
    for (let Index = 0; Index <= 0; Index++) {
        Linie(64 + Math.cos(radians(Index * 30)) * 50, (64 + Math.sin(radians(Index * 30))) * 50, (64 + Math.cos(radians(Index * 30)) * 50) * 60, (64 + Math.sin(radians(Index * 30))) * 60, Index)
    }
...
function Linie (x0: number, y0: number, x1: number, y1: number, i: number) {
